...
$sql->db_Select("advmedsys_awarded", "*", "awarded_user_id='".$postowner."' LIMIT 0,".$pref['nummed']."");
...
$sql2 = new db;
$sql2->db_Select("advmedsys_medals", "*", "medal_id=".$row['awarded_medal_id']." LIMIT 0,".$pref['nummed']."");
...
$sql->db_Select("advmedsys_awarded2", "*", "awarded_user_id='".$postowner."' LIMIT 0,".$pref['numrib']."");
while($row = $sql->db_Fetch()){
