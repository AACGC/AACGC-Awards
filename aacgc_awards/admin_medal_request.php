...
if (isset($_POST['main_delete'])) {
	...
	$sql2 = new db;
    $sql2->db_Delete("aacgcawards_medals_request", "request_id='".$delete_id[0]."'");
...
if ($action == "") {
        ...
        <td style='width:25%' class='forumheader3'>Medal</td>
        <td style='width:' class='forumheader3'>Options</td>
       </tr>";
        $sql->db_Select("aacgcawards_medals_request", "*", "ORDER BY request_id ASC","");
        ...
        <td style='width:25%' class='forumheader3'>".$row['medal_wanted']."</td>
...
$ns -> tablerender("Medal Requests", $text);
